...
M558 P7 X0 Y0 Z2 H2 F120 I0 T20000 			; Set Z probe type to switch, the axes for which it is used and the dive height + speeds
...
M584 X0 Y1 Z2 C7 E3:4:5:6 A8				; Apply custom drive mapping
...
; Heaters
M305 P0 S"BED" T100000 B4725 C7.06e-8 				; Set thermistor
...
;right side cleaning brush (A-axis)

M574 A1 S3 						; Set A endstop stalldetection
